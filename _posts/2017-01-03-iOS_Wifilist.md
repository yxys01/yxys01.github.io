...
- (void)getWifiList {
	...
	dispatch_queue_t queue = dispatch_queue_create("com.yxys01.HotspotHelper", 0);
...
在操作过程或者文章有问题的话欢迎在 [原文](https://yxys01.github.io/2017/01/iOS_Wifilist/) 里提问或指正。
...
<br>
转载请注明：[yxys01的博客](https://yxys01.github.io/) » [Wifi 定位原理及 iOS Wifi 列表获取 ](https://yxys01.github.io/2017/01/iOS_Wifilist/)  
